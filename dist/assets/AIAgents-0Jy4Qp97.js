import{r as i,j as e}from"./index-SH2_7EBP.js";import{u as N,V as A,a as j,A as E,F as I,e as T,s as p,B as H,b as x,S as z,C as k,f as V,M as B,c as C,P as W,N as G,O as $,W as D,g as F}from"./Universe-B-ewZ0qM.js";import"./business-CjkSvZ8M.js";const g=[{id:"support",name:"Customer Support",pos:[-.6,2.2,2.4],color:"#dbe6f2",skills:["Conversation","Decision making","Workflow","API execution","Escalation"]},{id:"ocr",name:"Document AI · OCR",pos:[2.4,-2.6,3.6],color:"#cfe0ff",skills:["Extraction","Classification","Validation","Structured output","Archival"]},{id:"crm",name:"CRM Copilot",pos:[6.4,2.6,2],color:"#dbe6f2",skills:["Lead scoring","Enrichment","Outreach drafts","Pipeline sync","Forecasting"]},{id:"automation",name:"Automation",pos:[9.6,-.8,3.2],color:"#dbe6f2",skills:["Triggers","Decision making","API execution","Retries","Audit trail"]},{id:"analytics",name:"Analytics",pos:[4.6,5.2,1.2],color:"#cfe0ff",skills:["Natural language Q&A","Aggregation","Anomaly detection","Forecasting","Reporting"]}],q=`
uniform float uTime;
